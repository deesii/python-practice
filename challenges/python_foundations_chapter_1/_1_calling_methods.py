...
def reverse_a_string(string):
    # your code goes here (delete the pass below)
    # i checked for in-built function using REPL pressing . after the string then holding down the tab key
    # used REPL to test single line within invoking the interpreter via running the program
    return string[::-1]
...
def swap_the_case_of_a_string(string):
    # your code goes here (delete the pass below)
    # could have used .swapcase() which is a built in function -- check in-built ones with . and holding down tab!
    swapped_case = ""
    for char in string:
        if char.isupper():
...
print(swap_the_case_of_a_string("Ysdsds   .,.,/HHH"))
