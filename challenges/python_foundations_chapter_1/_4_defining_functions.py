...
def add_number_strings(text_1, text_2):
...
def multiply_number_strings(text_1, text_2):
    return int(text_1) * int(text_2)
...
def both_odd (num_1, num_2):
    return num_1 % 2 == 1 and num_2 % 2 == 1
...
def both_even (num_1, num_2):
    return num_1 % 2 == 0 and num_2 % 2 == 0
...
def one_odd (num_1, num_2):
    return num_1 % 2 == 1 or num_2 % 2 == 1
...
def one_even(num_1, num_2):
    return num_1 % 2 == 0 or num_2 % 2 == 0
